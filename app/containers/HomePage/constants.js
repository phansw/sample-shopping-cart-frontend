export const GET_ITEMS_FROM_SERVER = 'tcb/Home/GET_ITEMS_FROM_SERVER';
export const SET_ITEMS = 'tcb/Home/SET_ITEMS';
export const SET_ITEM_LOADING_STATUS = 'tcb/Home/SET_ITEM_LOADING_STATUS';
